...
#ifndef BODYDEF_H 
#define BODYDEF_H 
#define INTEL_64_BIT 0xffffff00
//--计算标准UTF8ASCLL码
#define as_code( CODE ) ( long )  ( ( CODE ) ^ ( INTEL_64_BIT ) )
char data[][6] = { "a" ,"ai" ,"an" ,"ang" ,"ao" ,"ba" ,"bai" ,"ban" ,"bang" ,"bao" ,
...
long index[] = { -20319 ,-20317 ,-20304 ,-20295 ,-20292 ,-20283 ,-20265 ,-20257 ,-20242 ,-20230 ,
...
#define index_LENGTH  ( sizeof(index) )

#define DATA_CHR_LENGTH  ( ( sizeof(data) ) / ( 6 ))
